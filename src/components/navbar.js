          ...
          {session ? (
            <div className="flex items-center space-x-6">
              ...
              <button
                ...
                className="flex items-center space-x-2 px-4 py-2 rounded-lg bg-white text-green-600 hover:bg-green-50 transition-colors"
              >
            ...
            <div className="flex items-center space-x-4">
              ...
              <Link
                href="/auth/signup"
                className="px-4 py-2 rounded-lg bg-white text-green-600 hover:bg-green-50 transition-colors"
              >
                Sign Up
              </Link>
            </div>
