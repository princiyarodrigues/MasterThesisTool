...
import { data } from '../../../lib/data'; // Adjust the import path if needed
import { useEffect, useState } from 'react';

const KnowledgeDetailPage = ({ params }) => {
  ...
  // Ensure that 'data' is an array of objects with an 'id' field matching the URL parameter.
  const selectedOption = data ? data.find(option => option.id === id) : null;
