...
// Load JSON data
const capabilities = JSON.parse(fs.readFileSync('scripts/capabilities.json', 'utf8'));
...
// Self referenced relationship for capabilites. It is 1 to 1 relationship where there are parent and miultiple capabilites
